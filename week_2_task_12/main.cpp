 ...
 * Ќа вход программе поступают следующие запросы:
   ...
   - RENAME old_country_name new_country_name Ч переименование страны из old_country_name
   в new_country_name.
   ...
   разделЄнные пробелами пары country/capital, описывающие столицы всех стран и упор€доченные
   по названию страны, если в мире уже есть хот€ бы одна страна.
 */
#include <algorithm>
#include <iostream>
#include <map>
...
//  ѕереименование страны из old_country_name в new_country_name
...
//  »зменение столицы страны country на new_capital, либо добавление такой страны
//  с такой столицей, если раньше еЄ не было.
